---
title: "Sicegar Figures      Samples: SCV096, SCV097, SCV098, SCV099"
...
testName="15Aug2017"
listFileNames=c("SCV096","SCV097","SCV098","SCV099") # <- simply change this to pick up correct data
listConditionNames=c("EGFP", "mCherry", "EGFP+mCherry_EGFP_Sig", "EGFP+mCherry_mCherry_Sig") # <-  They are associated labels for datasets
listOrderNames=c("EGFP", "mCherry", "EGFP+mCherry_EGFP_Sig", "EGFP+mCherry_mCherry_Sig") # <- They are the order of labels 
#c("EGFP", "mCherry", "EGFP+mCherry", "EGFP+mCherry")
