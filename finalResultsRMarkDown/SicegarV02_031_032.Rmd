---
title: "Sicegar Figures      Samples: SCV028, SCV029, SCV030"
...
testName="15Aug2017"
listFileNames=c("SCV031","SCV032") # <- simply change this to pick up correct data
listConditionNames=c("0 µM 2'-C-meA", "50 µM 2'-C-meA") # <-  They are associated labels for datasets
listOrderNames=c("0 µM 2'-C-meA", "50 µM 2'-C-meA") # <- They are the order of labels 

colVec01=c("#e41a1c", "#377eb8") # <- simply change this to change figure colors
###*****************************
