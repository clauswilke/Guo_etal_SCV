---
title: "Sicegar Figures      Samples: SCV029, SCV031, SCV035"
...
testName = "24Aug2017"
listFileNames = c("SCV029","SCV031","SCV035") # <- simply change this to pick up correct data
listConditionNames = c("WT_500_samp29", "WT_500_samp31", "WT_500_samp35") # <-  They are associated labels for datasets
listOrderNames = c("WT_500_samp29", "WT_500_samp31", "WT_500_samp35") # <- They are the order of labels 
